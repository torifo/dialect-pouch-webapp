defmodule DialectPocket.Accounts.Admin do
  use Ecto.Schema
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, DialectPocket.Repo)
  ...
  """
  def valid_password?(%DialectPocket.Accounts.Admin{hashed_password: hashed_password}, password)
