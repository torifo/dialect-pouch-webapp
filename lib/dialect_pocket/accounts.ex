defmodule DialectPocket.Accounts do
  @moduledoc """
  ...
  alias DialectPocket.Accounts.{Admin, AdminToken, AdminNotifier}
  ...
  See `DialectPocket.Accounts.Admin.email_changeset/3` for a list of supported options.
  ...
  See `DialectPocket.Accounts.Admin.password_changeset/3` for a list of supported options.
