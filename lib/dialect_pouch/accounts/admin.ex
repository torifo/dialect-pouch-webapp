defmodule DialectPouch.Accounts.Admin do
  use Ecto.Schema
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, DialectPouch.Repo)
  ...
  """
  def valid_password?(%DialectPouch.Accounts.Admin{hashed_password: hashed_password}, password)
